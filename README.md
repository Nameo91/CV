...
| ---------------------------- | ----------------- | ----------------- |
| **[Merry Crypto](https://github.com/Nameo91/merrycrypto-deploy)** | Don’t be Grinch, join **MerryCrypto**! A cryptocurrency data aggregator with an inbuilt portfolio manager <br/> [Presentation](https://youtu.be/jNPUt79UpsA?t=2056) on Demo Day | Angular, NestJS, TypeScript, Jest, TypeORM, Psql, RESTful API, Git |
